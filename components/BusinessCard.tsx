...
export default function BusinessCard() {
    ...
    return (
        <Tilt tiltReverse={true} scale={scale} transitionSpeed={3000} perspective={10000} tiltMaxAngleX={10} tiltMaxAngleY={10} className="w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl 2xl:max-w-3xl aspect-[1.75] flex items-center justify-center">
